...
_GroceryEntry _$GroceryEntryFromJson(Map<String, dynamic> json) =>
    _GroceryEntry(
      ...
      paymentSource: json['paymentSource'] as String? ?? 'mess_fund',
      amountFromMess: (json['amountFromMess'] as num?)?.toDouble() ?? 0.0,
      amountFromMember: (json['amountFromMember'] as num?)?.toDouble() ?? 0.0,
...
Map<String, dynamic> _$GroceryEntryToJson(_GroceryEntry instance) =>
    <String, dynamic>{
      ...
      'amountFromMess': instance.amountFromMess,
      'amountFromMember': instance.amountFromMember,
