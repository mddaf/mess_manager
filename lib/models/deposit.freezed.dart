...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,memberId,memberName,amount,date,note,createdAt);

@override
String toString() {
  return 'Deposit(id: $id, memberId: $memberId, memberName: $memberName, amount: $amount, date: $date, note: $note, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String memberId, String memberName, double amount, String date, String note, DateTime? createdAt
});
...
/// Create a copy of Deposit
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? memberId = null,Object? memberName = null,Object? amount = null,Object? date = null,Object? note = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String memberId,  String memberName,  double amount,  String date,  String note,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Deposit() when $default != null:
return $default(_that.id,_that.memberId,_that.memberName,_that.amount,_that.date,_that.note,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String memberId,  String memberName,  double amount,  String date,  String note,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Deposit():
return $default(_that.id,_that.memberId,_that.memberName,_that.amount,_that.date,_that.note,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String memberId,  String memberName,  double amount,  String date,  String note,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Deposit() when $default != null:
return $default(_that.id,_that.memberId,_that.memberName,_that.amount,_that.date,_that.note,_that.createdAt);case _:
  return null;
...
class _Deposit implements Deposit {
  const _Deposit({required this.id, required this.memberId, required this.memberName, required this.amount, required this.date, this.note = '', this.createdAt});
...
/// Create a copy of Deposit
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? memberId = null,Object? memberName = null,Object? amount = null,Object? date = null,Object? note = null,Object? createdAt = freezed,}) {
